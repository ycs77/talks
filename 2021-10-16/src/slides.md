...
highlighter: shiki
download: https://talks.star-note-lucas.me/2021/laravel-vue-conf-taiwan/pdf
info: |
...
<h1 class="!font-light"><strong class="!text-livewire">Livewire</strong> vs <strong class="!text-inertia">Inertia.js</strong></h1>
...
# Vue.js <fa-solid-arrow-right class="inline-block w-6 h-6 text-indigo-300" /> <strong class="!text-inertia">Inertia.js</strong>

---

# 簡報

- 簡報：[網頁版](https://talks.star-note-lucas.me/2021/laravel-vue-conf-taiwan/) | [PDF 下載](https://talks.star-note-lucas.me/2021/laravel-vue-conf-taiwan/pdf)
